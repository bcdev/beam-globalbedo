...
/**
 * PlugIn class which provides a Meteosat Second Generation MSA  product reader to the framework.
 *
 * @author Olaf Danne
 */
public class MsgMSAProductReaderPlugIn implements ProductReaderPlugIn {
    ...
    private boolean isInputBz2FileNameValid(String fileName) {
        return fileName.matches(MsgMSAProductReader.MSA_ALBEDO_BZ2_FILENAME_REGEXP) ||
                fileName.matches(MsgMSAProductReader.MSA_ALBEDO_NOEXT_FILENAME_REGEXP);
    }
