 ...
 */
public class Modis35MetadataUtils {
    ...
    public static MetadataElement readAttributeList(final List<Attribute> attributeList,
        ...
        for (Attribute attribute : attributeList) {
            // MOD35: skip attributes which contain weird characters!!
            if (!attribute.getShortName().toUpperCase().contains("UW_DESTRIPE")) {
