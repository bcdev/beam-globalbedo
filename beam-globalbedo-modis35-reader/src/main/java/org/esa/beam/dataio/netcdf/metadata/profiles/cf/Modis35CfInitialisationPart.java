...
public class Modis35CfInitialisationPart extends Modis35ProfileInitPartIO {
    ...
    @Override
    public Product readProductBody(Modis35ProfileReadContext ctx) throws ProductIOException {
        Product product = new Product(
                (String) ctx.getProperty(Modis35Constants.PRODUCT_FILENAME_PROPERTY),
                readProductType(ctx),
    ...
    public String readProductType(final Modis35ProfileReadContext ctx) {
        ...
        if (productType != null) {
            ...
            return Modis35Constants.FORMAT_NAME;
        }
    }
}
