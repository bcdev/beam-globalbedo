 ...
 * @author olafd
 */
public class Modis35DaacAttributes implements ModisGlobalAttributes {
    ...
    public Modis35DaacAttributes(NetCDFVariables netCDFVariables) {
    ...
    static boolean isHeightDimension(ucar.nc2.Dimension dimension) {
        ...
        return dimensionName.contains("Cell_Along_Swath_1km");
    }

    // package access for testing only tb 2012-05-22
    static boolean isWidthDimension(ucar.nc2.Dimension dimension) {
        final String dimensionName = dimension.getShortName();
        return dimensionName.contains("Cell_Across_Swath_1km");
    }
