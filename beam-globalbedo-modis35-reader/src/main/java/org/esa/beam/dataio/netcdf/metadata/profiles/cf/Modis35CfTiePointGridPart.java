...
public class Modis35CfTiePointGridPart extends Modis35ProfilePartIO {
    ...
    public void preEncode(Modis35ProfileWriteContext ctx, Product p) throws IOException {
        Modis35CfBandPart.defineRasterDataNodes(ctx, p.getTiePointGrids());
    }
    ...
    private boolean getYFlippedProperty(Modis35ProfileWriteContext ctx) {
        Object yFlippedProperty = ctx.getProperty(Modis35Constants.Y_FLIPPED_PROPERTY_NAME);
