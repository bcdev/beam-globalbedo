 ...
 */
public class Modis35NetcdfOpImage extends SingleBandedOpImage {
    ...
    public static RenderedImage createLsbImage(Variable variable, int[] imageOrigin, boolean flipY,
        ...
        return new Modis35NetcdfOpImage(variable, imageOrigin, flipY, readLock, dataBufferType, sourceWidth, sourceHeight,
     ...
     */
    public Modis35NetcdfOpImage(Variable variable, int[] imageOrigin, boolean flipY, Object readLock, int dataBufferType,
                                int sourceWidth, int sourceHeight,
                                Dimension tileSize, ResolutionLevel level) {
    ...
    private Modis35NetcdfOpImage(Variable variable, int[] imageOrigin, boolean flipY, Object readLock, int dataBufferType,
                                 int sourceWidth, int sourceHeight,
        ...
        Modis35DimKey rasterDim = new Modis35DimKey(variableDimensions.toArray(new ucar.nc2.Dimension[variableDimensions.size()]));
        xIndex = rasterDim.findXDimensionIndex();
        yIndex = rasterDim.findYDimensionIndex();
        startIndexToCopy = Modis35DimKey.findStartIndexOfBandVariables(variableDimensions);
    }
