...
public class CfFlagCodingPartTest extends TestCase {
    ...
    public void testReplaceNonWordCharacters() {
       assertEquals("a_b", Modis35CfFlagCodingPart.replaceNonWordCharacters("a/b"));
       assertEquals("a_b", Modis35CfFlagCodingPart.replaceNonWordCharacters("a / b"));
       assertEquals("a_b", Modis35CfFlagCodingPart.replaceNonWordCharacters("a.b"));
    }
    ...
    public void testWriteFlagCoding() throws Exception {
        ...
        Modis35CfBandPart.writeCfBandAttributes(flagBand, new N3Variable(variable, writeable));
        Modis35CfFlagCodingPart.writeFlagCoding(flagBand, new N3FileWriteable(writeable));
