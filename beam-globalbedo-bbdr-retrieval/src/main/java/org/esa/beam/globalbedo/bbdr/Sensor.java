...
public enum Sensor {
    ...
    AATSR_NADIR("AATSR_NADIR", 4, 0.05, 1, 2, 1.008, 0.997, 0.04, 0.15, AATSR_CALIBRATION_COEFFS, AATSR_WAVELENGHTS, 1.2,
                AATSR_TOA_BAND_NAMES_NADIR, AATSR_NADIR_ANCILLARY_BAND_NAMES, AATSR_SDR_BAND_NAMES_NADIR, AATSR_SDR_ERROR_BAND_NAMES_NADIR,
                LAND_EXPR_AATSR, ""),
    AATSR_FWARD("AATSR_FWARD", 4, 0.05, 1, 2, 1.008, 0.997, 0.04, 0.15, AATSR_CALIBRATION_COEFFS, AATSR_WAVELENGHTS, 1.4,
