...
public class BbdrMeteosatTest {
    ...
    public void testExtractInputParmsFromFilename() {
        ...
        double[] parmsFromFilename = MeteosatBbdrFromBrfOp.extractInputParmsFromFilename(filename, MeteosatSensor.MVIRI);
        ...
        parmsFromFilename = MeteosatBbdrFromBrfOp.extractInputParmsFromFilename(filename, MeteosatSensor.SEVIRI);
        ...
        parmsFromFilename = MeteosatBbdrFromBrfOp.extractInputParmsFromFilename(filename, MeteosatSensor.MVIRI);
