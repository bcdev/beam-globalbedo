 ...
 * for each tile (eg. h18v03), mosaic subdivision number d (eg. 02) and resolution res (005) it creates text file:
 * tile.res.d.txt (eg h18v03.005.02.txt)
 * The line in resulted files is inserted like that:
 * index_tilePixel:index_gridPixel1,centroidsDistance1,ratioCommonArea1;index_gridPixel2,centroidDistance2,ratioCommonArea2;...
 *
