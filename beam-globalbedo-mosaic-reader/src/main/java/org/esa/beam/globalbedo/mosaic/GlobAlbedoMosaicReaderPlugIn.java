 ...
 * @author  MarcoZ
 */
public class GlobAlbedoMosaicReaderPlugIn implements ProductReaderPlugIn {
    ...
    private static final String FORMAT_NAME = "GLOBALBEDO-L3-MOSAIC";
    ...
    public ProductReader createReaderInstance() {
        return new GlobAlbedoMosaicProductReader(this);
    }
