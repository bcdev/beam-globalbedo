...
def WriteDataset(File, Monthly_DHR, Monthly_BHR, Monthly_DHR_SD, Monthly_BHR_SD, Monthly_NSamples, Monthly_RelativeEntropy, Monthly_GoodnessOfFit, Monthly_SnowFraction, Monthly_DataMask, Tile):
    ...
    header_template = open("/data/GlobAlbedo/src/metadata/generic_header_MonthlyAlbedo.hdr")
...
OUTDIR = os.getcwd()
OutputFilename = '/data/GlobAlbedo/MonthlyAlbedo/' + Tile + '/GlobAlbedo.2005' + Month + '.' + Tile + '.bin'
WriteDataset(OutputFilename, Monthly_DHR, Monthly_BHR, Monthly_DHR_SD, Monthly_BHR_SD, Monthly_NSamples, Monthly_RelativeEntropy, Monthly_GoodnessOfFit, Monthly_SnowFraction, Monthly_DataMask, Tile)
