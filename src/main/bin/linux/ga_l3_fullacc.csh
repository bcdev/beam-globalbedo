...
time $beamRootDir/bin/gpt-ga.sh  ga.l3.fullacc -Ptile=$tile -Pyear=$year -PstartDoy=$StartDay -PendDoy=$EndDay -Pwings=$wings -PcomputeSnow=false -PgaRootDir=$gaRootDir -e &
time $beamRootDir/bin/gpt-ga.sh  ga.l3.fullacc -Ptile=$tile -Pyear=$year -PstartDoy=$StartDay -PendDoy=$EndDay -Pwings=$wings -PcomputeSnow=true -PgaRootDir=$gaRootDir -e &
