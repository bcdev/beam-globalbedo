...
submit_job() {
    ...
    # L3 albedo mosaics:
    # for 005:
    #bsubmit="bsub -q high-mem -W 180 -R rusage[mem=96000] -M 96000000 -P ga_qa4ecv -cwd ${GA_INST} -oo ${GA_LOG}/${jobname}.out -eo ${GA_LOG}/${jobname}.err -J ${jobname} ${GA_INST}/${command} ${@:3}"
    # for 05:
    bsubmit="bsub -q short-serial -W 180 -R rusage[mem=64000] -M 64000000 -P ga_qa4ecv -cwd ${GA_INST} -oo ${GA_LOG}/${jobname}.out -eo ${GA_LOG}/${jobname}.err -J ${jobname} ${GA_INST}/${command} ${@:3}"
