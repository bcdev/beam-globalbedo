...
submit_job() {
    ...
    # L3 full acc (set duration to max. 3h):
    #bsubmit="bsub -W 180 -R rusage[swp=16000] -P ga_qa4ecv -cwd ${GA_INST} -oo ${GA_LOG}/${jobname}.out -eo ${GA_LOG}/${jobname}.err -J ${jobname} ${GA_INST}/${command} ${@:3}"
