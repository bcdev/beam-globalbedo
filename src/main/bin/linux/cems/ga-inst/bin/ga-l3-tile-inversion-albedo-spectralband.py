...
for tile in tiles:
    for bandIndex in bandIndices:
        ...
        m.execute('ga-l3-tile-inversion-dailyacc-spectralband-step.sh',
                         ['sdrs'],
                         [postCond],
                         parameters=[bandIndex,tile,year,startDoy,endDoy,'8',gaRootDir,spectralSdrRootDir,beamDir])
        ...
        for iyear in range(startYear, endYear+1):
            ...
            m.execute('ga-l3-tile-inversion-albedo-spectralband-step.sh', 
                         allDailyAccPostConds, 
		         [postCond], 
                         parameters=[sensorID,bandIndex,tile,year,startDoy,endDoy,gaRootDir,spectralSdrRootDir,spectralInversionRootDir,beamDir,spectralAlbedoDir])
