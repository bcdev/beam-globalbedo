...
# count existing marker files and create final marker file if we are done for all not 46 but 16  DoYs of given year:
...
if [ $numDailyAccsNoSnow -eq 16 ] # for priotest!
then
