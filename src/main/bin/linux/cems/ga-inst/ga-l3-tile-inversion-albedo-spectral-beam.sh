...
TARGET=${spectralInversionNosnowTargetDir}/Qa4ecv.brdf.$year$doy.$tile.${subStartX}_${subStartY}.NoSnow.nc
...
if [ "$status" -eq 0 ]; then
    ...
    TARGET=${spectralInversionSnowTargetDir}/Qa4ecv.brdf.$year$doy.$tile.${subStartX}_${subStartY}.Snow.nc
