        ...
        #for idoy in range(180,331):    
            ...
            for resolution in resolutions:
                ...
                if mosaicMode == 'simple':
                    ...
                    m.execute('ga-l3-albedomosaic-simple-avhrrgeo-step.sh', [albedoTileDir], [albedoMosaicDir], parameters=[year,doy,snowMode,resolution,tileSize,gaRootDir,beamDir])
                else:
                    ...
                    m.execute('ga-l3-brdfmosaic-avhrrgeo-step.sh', [brdfTileDir], [brdfMosaicDir], parameters=[year,doy,snowMode,resolution,tileSize,gaRootDir,beamDir])

                    ## BRDF mosaic --> Albedo mosaic
                    albedoMosaicDir = gaRootDir + '/Mosaic/albedo/' + snowMode + '/' + resolution
                    m.execute('ga-l3-albedomosaic-avhrrgeo-step.sh', [brdfMosaicDir], [albedoMosaicDir], parameters=[year,doy,snowMode,resolution,gaRootDir,beamDir])
