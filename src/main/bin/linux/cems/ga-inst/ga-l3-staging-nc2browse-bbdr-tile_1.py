...
#for idoy in range(0,31):
   ...
   if sensor == 'MVIRI':
       if lonGeo == '000': 
           ...
           stagingNc2browseFile = bbdrTileDir + '/W_XX-EUMETSAT-Darmstadt,VIS+SATELLITE,MET5+MVIRI_063_C_BBDR_EUMP_' + year + datestring[5:7] + datestring[8:10] + '000000_' + tile + '.nc' 
