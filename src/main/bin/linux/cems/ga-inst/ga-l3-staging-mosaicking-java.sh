...
INDIR=/group_workspaces/cems/globalalbedo/public/tmp_od/tmp/
...
matchFolder=/group_workspaces/cems/globalalbedo/public/match_v2/

#JARFILE
#JARFILE=/home/users/saidkharbouche/jar2/mosaiking.jar 
JARFILE=/group_workspaces/cems/globalalbedo/scripts/jar/mosaiking.jar
