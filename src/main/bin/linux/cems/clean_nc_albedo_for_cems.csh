...
#Add units:
#ncatted -a units,'DHR_VIS',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'DHR_NIR',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'DHR_SW',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'DHR_sigmaVIS',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'DHR_sigmaNIR',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'DHR_sigmaSW',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_VIS',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_NIR',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_SW',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_sigmaVIS',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_sigmaNIR',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'BHR_sigmaSW',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'Weighted_Number_of_Samples',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'Relative_Entropy',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'Goodness_of_Fit',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'Snow_Fraction',c,c,"dimensionless" $NC_INPUT
#ncatted -a units,'Data_Mask',c,c,"dimensionless" $NC_INPUT
ncatted -a units,'Solar_Zenith_Angle',c,c,"degrees" $NC_INPUT
#ncatted -a units,'crs',c,c,"dimensionless" $NC_INPUT
