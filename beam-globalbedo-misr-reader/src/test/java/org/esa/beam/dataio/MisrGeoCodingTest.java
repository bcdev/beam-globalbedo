...
/**
 * Test class for MisrGeoCoding
 *
 * @author olafd
 * @author norman
 */
public class MisrGeoCodingTest {
    @Test
    public void testDefaults() throws Exception {
        ...
        final MisrGeoCoding gc = new MisrGeoCoding(latBand, lonBand, "");
    ...
    public void testGetGeoPos() throws Exception {
        final MisrGeoCoding gc = createTestGC();
    ...
    public void testPixelBoxLut() throws Exception {
        MisrGeoCoding.PixelBoxLut pixelBoxLut = new MisrGeoCoding.PixelBoxLut(-1.0, 1.0, 1000);
    ...
    public void testFillIncompletePixelBoxLut() throws Exception {
        MisrGeoCoding.PixelBoxLut lut = new MisrGeoCoding.PixelBoxLut(0.0, 1.0, 10);
        lut.add(0.0, 1, 2);
        lut.add(0.4, 7, 11);
        lut.add(0.6, 3, 4);
        lut.add(0.7, 6, 22);
        lut.add(1.0, 2, 16);
        assertEquals(new MisrGeoCoding.PixelBox(1, 2), lut.getPixelBox(0.0));
        assertNull(lut.getPixelBox(0.1));
        assertNull(lut.getPixelBox(0.2));
        assertNull(lut.getPixelBox(0.3));
        assertEquals(new MisrGeoCoding.PixelBox(7, 11), lut.getPixelBox(0.4));
        assertNull(lut.getPixelBox(0.5));
        assertEquals(new MisrGeoCoding.PixelBox(3, 4), lut.getPixelBox(0.6));
        assertEquals(new MisrGeoCoding.PixelBox(6, 22), lut.getPixelBox(0.7));
        assertNull(lut.getPixelBox(0.8));
        assertEquals(new MisrGeoCoding.PixelBox(2, 16), lut.getPixelBox(0.9));
        assertEquals(new MisrGeoCoding.PixelBox(2, 16), lut.getPixelBox(1.0));

        lut.complete();
        assertEquals(new MisrGeoCoding.PixelBox(1, 2, 1, 2), lut.getPixelBox(0.0));
        assertEquals(new MisrGeoCoding.PixelBox(1, 2, 7, 11), lut.getPixelBox(0.1));
        assertEquals(new MisrGeoCoding.PixelBox(1, 2, 7, 11), lut.getPixelBox(0.2));
        assertEquals(new MisrGeoCoding.PixelBox(1, 2, 7, 11), lut.getPixelBox(0.3));
        assertEquals(new MisrGeoCoding.PixelBox(7, 11, 7, 11), lut.getPixelBox(0.4));
        assertEquals(new MisrGeoCoding.PixelBox(3, 4, 7, 11), lut.getPixelBox(0.5));
        assertEquals(new MisrGeoCoding.PixelBox(3, 4, 3, 4), lut.getPixelBox(0.6));
        assertEquals(new MisrGeoCoding.PixelBox(6, 22, 6, 22), lut.getPixelBox(0.7));
        assertEquals(new MisrGeoCoding.PixelBox(2, 16, 6, 22), lut.getPixelBox(0.8));
        assertEquals(new MisrGeoCoding.PixelBox(2, 16, 2, 16), lut.getPixelBox(0.9));
        assertEquals(new MisrGeoCoding.PixelBox(2, 16, 2, 16), lut.getPixelBox(1.0));

    }

    private MisrGeoCoding createTestGC() throws IOException {
        final Product product = new Product("test", "test", 3, 3);
        ...
        return new MisrGeoCoding(latBand, lonBand, "");
    }
}
