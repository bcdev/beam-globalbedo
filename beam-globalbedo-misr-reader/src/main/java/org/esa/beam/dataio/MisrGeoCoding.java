 ...
 * @author norman
 */
public class MisrGeoCoding extends AbstractGeoCoding {
    ...
    private MisrQuadTreeSearch mqts;

    public MisrGeoCoding(Band latitude, Band longitude, String regionID) throws IOException {
        ...
        mqts = new MisrQuadTreeSearch(latData, lonData, width, regionID);
    }
    ...
    public PixelPos getPixelPos(GeoPos geoPos, PixelPos pixelPos) {
        ...
        final MisrQuadTreeSearch.Result result = new MisrQuadTreeSearch.Result();
