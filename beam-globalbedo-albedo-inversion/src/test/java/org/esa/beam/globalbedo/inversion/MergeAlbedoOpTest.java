...
public class MergeAlbedoOpTest extends TestCase {
    ...
    public void testGetWeightedMergeValue() {
        ...
        double priorNoSnowSnowFraction = 0.5;
        double priorSnowSnowFraction = 0.5;
        double mergeValue = MergeAlbedoOp.getWeightedMergeValue(noSnowValue, snowValue, propNoSnow, propSnow,
                                                                priorNoSnowSnowFraction, priorSnowSnowFraction, sza);
        ...
        propNoSnow = 0.9;
        propSnow = 0.1;
        mergeValue = MergeAlbedoOp.getWeightedMergeValue(noSnowValue, snowValue, propNoSnow, propSnow,
                                                         priorNoSnowSnowFraction, priorSnowSnowFraction, sza);
        ...
        priorNoSnowSnowFraction = 0.25;
        priorSnowSnowFraction = 0.75;
        mergeValue = MergeAlbedoOp.getWeightedMergeValue(noSnowValue, snowValue, propNoSnow, propSnow,
                                                         priorNoSnowSnowFraction, priorSnowSnowFraction, sza);
        assertEquals(0.65, mergeValue, 1.E-3);

        priorNoSnowSnowFraction = 0.5;
        priorSnowSnowFraction = 0.5;
        sza = 60.0;
