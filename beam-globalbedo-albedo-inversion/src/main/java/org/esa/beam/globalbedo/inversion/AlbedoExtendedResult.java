 ...
 */
public class AlbedoExtendedResult {
    ...
    public AlbedoExtendedResult(double[] bsa, double[] bsaAlpha, Matrix[] bsaSigma,
    ...
    public AlbedoExtendedResult(double[] bsa, double[] bsaAlpha, double[] bsaSigma,
